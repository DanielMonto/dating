...
extension DatingQueryFilter on QueryBuilder<Dating, Dating, QFilterCondition> {
  QueryBuilder<Dating, Dating, QAfterFilterCondition> dateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Dating, Dating, QAfterFilterCondition> dateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Dating, Dating, QAfterFilterCondition> dateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Dating, Dating, QAfterFilterCondition> dateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DatingQuerySortBy on QueryBuilder<Dating, Dating, QSortBy> {
  QueryBuilder<Dating, Dating, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<Dating, Dating, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DatingQuerySortThenBy on QueryBuilder<Dating, Dating, QSortThenBy> {
  QueryBuilder<Dating, Dating, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<Dating, Dating, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }
...
extension DatingQueryWhereDistinct on QueryBuilder<Dating, Dating, QDistinct> {
  QueryBuilder<Dating, Dating, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
...
extension DatingQueryProperty on QueryBuilder<Dating, Dating, QQueryProperty> {
  ...
  QueryBuilder<Dating, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
