...
class ProcessCardCounter extends StatefulWidget {
  final Process process;
  const ProcessCardCounter({super.key, required this.process});

  @override
  State<ProcessCardCounter> createState() => _ProcessCardCounterState();
}

class _ProcessCardCounterState extends State<ProcessCardCounter> {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime now = context.watch<GlobalTimer>().now;
